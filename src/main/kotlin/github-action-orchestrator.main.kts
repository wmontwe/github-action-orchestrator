...
@file:DependsOn("io.ktor:ktor-client-core-jvm:3.1.1")
@file:DependsOn("io.ktor:ktor-client-cio-jvm:3.1.1")
@file:DependsOn("io.ktor:ktor-client-logging-jvm:3.1.1")
@file:DependsOn("io.ktor:ktor-client-content-negotiation-jvm:3.1.1")
@file:DependsOn("io.ktor:ktor-serialization-gson-jvm:3.1.1")
